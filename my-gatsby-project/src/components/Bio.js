          ...
          <div className="about-main-section">
            <ul className="about-list">
              <li>
                ...
                <p className="tag-info">George Jindo</p>
                <p>&#125;</p>
              </li>
              <li>
                <p>
                ...
                <p className="tag-info">
                  I am from New York, where she I work as a senior web engineer
                  at Flywheel, WordPress hosting for creatives. I has 6 years of
                  experience as a Full Stack engineer with a focus on APIs and
                  creating responsive sites. In my spare time you can find me
                  listening to true-crime podcasts, skateboarding in Prospect
                  Park or teaching a spin class.{" "}
                </p>
                <p>&#125;</p>
              </li>
              <li>
